...
default[:infainstaller][:tarfile] = "951HF1_Server_Installer_linux-x64.tar"
...
default[:infainstaller][:installto][:user] = 		"cehdp"
default[:infainstaller][:installto][:group] = 		"cehdp"
...
default[:infainstaller][:silentinput][:db_uname] = "ldtmqa8"
default[:infainstaller][:silentinput][:db_passwd] = "ldtmqa8"
...
default[:infainstaller][:silentinput][:db_servicename] = "QARUC11GTAF"
default[:infainstaller][:silentinput][:db_address] = "pslxqarac1-drac:1521"
